...
int wolfSSL_set_fd(WOLFSSL* ssl, fd_t fd)
{
...
fd_t wolfSSL_get_fd(const WOLFSSL* ssl)
{
...
/* old NO_FILESYSTEM end */
    ...
    int wolfSSL_set_rfd(WOLFSSL* ssl, fd_t rfd)
    {
    ...
    int wolfSSL_set_wfd(WOLFSSL* ssl, fd_t wfd)
    {
